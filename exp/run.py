...
import random
import numpy as np
from exp.e import Experiment
from params import parse_args as pa
from exp.make_data import enso_data
...
def data_loader(args, start):
    path = args.data_path
    cmip = args.cmip
    f_num = args.f_num
    gap = 1
    loader = enso_data(path, cmip, f_num, gap,args.batch_size, args.num_workers,start, 'el20')
    return loader
if __name__ == '__main__':
    ...
    enso = Experiment(args, device, model, optimizer, schedular, loader)
    setting = '{}_{}_{}_{}_{}_{}_{}'.format(args.batch_size, args.epochs, args.feature, args.num_caps,
                                         args.num_route, args.d_model, start)
    print('>>>>>>>start>>>>>>>>>>>>>>>>>>>>>>>>>>')
    enso.test0(setting)
